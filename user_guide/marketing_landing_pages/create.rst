...
#. Fill in the landing page title (**Titles**) and translate it into the languages supported in your OroCommerce configuration. 
   ...
   To manage title translations, click |IcTranslate| next to the **Titles** box and follow the guidance `here <../../common_actions/manage_translation.html>`_).
...
#. Click on the Slug Prototypes box. The default slug prototype will be autogenerated. Edit the value to customize the default.
   ...
   To ensure that slug prototype trnaslation is localization-friendly, manage slug prototype translations: click |IcTranslate| next to the **Slug Prototypes** box and follow the guidance `here <../../common_actions/manage_translation.html>`_).

#. Enter the landing page content in the `WYSIWYG text editor <../../common_actions/using_WYSIWYG_text_editor.html>`_ or use the source code mode (**<>**) to enter the html code.
