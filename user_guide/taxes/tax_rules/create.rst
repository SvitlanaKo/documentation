...
1. `Create a tax jurisdiction <./../tax_jurisdictions/create>`_ (country, state and a range of zip codes) where a special taxation rules apply.

2. Create customer tax codes for every group of buyers that have fixed tax rates in this tax jurisdiction. `Link the customer groups to their respective tax codes <./../link_tax_code_to_a_customer>`_.

3. Create product tax codes for every group of products that have fixed tax rates in this tax jurisdiction. Ensure that these tax codes are `assigned to the products <./../link_a_tax_code_to_a_product>`_.
