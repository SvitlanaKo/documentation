               ...
               <div class="promo-block">
                  ...
                  <p>Learn how to set up product and category visibility restrictions, customer user registration options, and manage contact requests.</p> 
                    <ul class="guideline__list">
                      <li><a class="reference internal" href="../../user-guide/customers/configuration/visibility#sys-config-configuration-commerce-customers-visibility"><span class="std std-ref">Visibility</span></li>
                      <li><a class="reference internal" href="../../user-guide/customers/configuration/global_customer_users#sys-config-configuration-commerce-customers-customer-users"><span class="std std-ref">Customer Users</span> <i class="fa fa-building-o fa-lg" aria-hidden="true" style="color:#56A5EC"></i> <i class="fa fa-globe" aria-hidden="true" style="color:#56A5EC"></i></li>
          ...
          <div class="center-block pull-left slide-blocks">
               <div class="promo-block">
                  ...
                  <p>Learn how to select theme settings, page and menu templates.</p>
                   <ul><li><a class="reference internal" href="../user_guide/system/commerce_configuration/design/theme_global#configuration-commerce-design-theme-theme-settings-globally"><span class="std std-ref">Theme</span></a> <i class="fa fa-building-o fa-lg" aria-hidden="true" style="color:#56A5EC"></i> <i class="fa fa-globe" aria-hidden="true" style="color:#56A5EC"></i></li></ul>
               </div>
          </div>
      </div>
   </div>
    ...
    <div>
      <div  style="float:left;">
                <ul class="guideline__list">
                     ...
                     <li><a class="reference internal" href="commerce/product/product_images#configuration-guide-commerce-configuration-product-images"><span class="std std-ref">Product Images</span></a> <i class="fa fa-building-o fa-lg" aria-hidden="true" style="color:#56A5EC"></i> <i class="fa fa-globe" aria-hidden="true" style="color:#56A5EC"></i></li>
                ...
                <ul class="guideline__list">
                     <li><a class="reference internal" href="commerce/product/promotions#configuration-guide-commerce-configuration-promotions"><span class="std std-ref">Promotions</span> <i class="fa fa-building-o fa-lg" aria-hidden="true" style="color:#56A5EC"></i> <i class="fa fa-globe" aria-hidden="true" style="color:#56A5EC"></i></li>
                     <li><a class="reference internal" href="../../user_guide/marketing_web_catalog/configuration/index#configuration-guide-commerce-configuration-product-collections"><span class="std std-ref">Product Collections</span></a></li>
                    </ul>
