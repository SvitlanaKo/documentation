   ...
   <div class="guideline">
      <div class="guideline__item" style="background-color: #FFFFFF">
          ...
          <img src="../_images/system_config.png" alt="SystemConfig">
            <a class="reference internal" href="configuration_guide/system_configuration#configuration-guide-system-configuration"><span class="std std-ref">System Configuration</span></a></h3>
            </div>
      ...
      <div class="guideline__item" style="background-color: #FFFFFF">
          ...
          <a class="reference internal" href="configuration_guide/commerce#configuration-guide-commerce-configuration"><span class="std std-ref">Commerce Configuration</span></a></h3>
          </div>
          <div style="overflow: hidden;margin: 0 auto;width: 100%;height:100%;text-align: left">
          </div>
      </div>
      ...
      <div class="guideline__item" style="background-color: #FFFFFF">
          ...
          <a class="reference internal" href="configuration_guide/crm#configuration-guide-crm-configuration"><span class="std std-ref">CRM Configuration</span></a></h3>
          </div>
          <div style="overflow: hidden;margin: 0 auto;width: 100%;height:100%;text-align: left">
          </div>
      </div>
      ...
      <div class="guideline__item" style="background-color: #FFFFFF">
          ...
          <img src="../_images/marketing_config.png" alt="MarketingConfig">
           <a class="reference internal" href="configuration_guide/marketing#configuration-guide-marketing-configuration"><span class="std std-ref">Marketing Configuration</span></a></p></h3>
          </div>
          <div style="overflow: hidden;margin: 0 auto;width: 100%;height:100%;text-align: left">
          </div>
      </div>
