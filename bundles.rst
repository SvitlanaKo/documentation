...
`CampaignBundle`_ (OroCRM)
    ...
    .. seealso::
        ...
        * User guide: :doc:`/user_guide_roles/marketing_tools/automation/marketing_campaigns`
        * User guide: :doc:`/user_guide_roles/marketing_tools/automation/email_campaigns`
        * User guide: :doc:`/user_guide_roles/marketing_tools/tracking/index`
...
`ChannelBundle`_ (OroCRM)
    ...
    .. seealso::
        ...
        * User guide: :doc:`/user_guide/customer_management/common_features_accounts`
        * User guide: :doc:`/user_guide_roles/sales_tools/magento/magento_channels`
...
`MarketingListBundle`_ (OroCRM)
    ...
    .. seealso::
        ...
        * User guide: :doc:`/user_guide_roles/marketing_tools/automation/marketing_lists`
...
`ReportBundle`_ (OroPlatform and OroCRM)
    ...
    .. seealso::
        ...
        * Book: :doc:`/book/reports_configuration`
        * User guide: :doc:`/user_guide/customer_management/common_features_accounts`
        * User guide: :doc:`/user_guide_roles/sales_tools/b2b_sales/business_customers`
        * User guide: :doc:`/user_guide_roles/sales_tools/b2b_sales/leads`
        * User guide: :doc:`/user_guide_roles/sales_tools/b2b_sales/opportunities/index`
...
`SalesBundle`_ (OroCRM)
    ...
    .. seealso::
        ...
        * User guide: :doc:`/user_guide_roles/sales_tools/b2b_sales/index`
