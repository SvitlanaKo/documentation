...
course of the system integration. Mostly, this actions are related to :ref:`OroCommerce extensions <admin-package-manager>`.

You can view and activate/deactivate the process in the OroCommerce:
