...
Extensions are additional modules that can be added to an Oro application to enable new features (integrations, capabilities, etc.).
...
To add an extension, navigate **System > Package Manager** in the main menu.
...
available, the **Update** link show up in the **LATEST VERSION** column.
