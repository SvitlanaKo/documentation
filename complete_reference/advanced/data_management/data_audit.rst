...
.. image:: /complete_reference/img/advanced/data_audit/data_audit_ex.png

History of Changes
------------------

A link to a specific record's history of changes is available in the top right corner of the item details, if Data Audit has been enabled for the user. (The Data Audit capabilty has been enabled for at least one of the user's `roles <../../system/user_management/roles.html>`_).
