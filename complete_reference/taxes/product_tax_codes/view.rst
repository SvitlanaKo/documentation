...
#. Find the line with the necessary Product Tax Code and click on it.
   ...
   * List of products with this product tax code
   ...
   .. image:: /complete_reference/img/taxes/product_tax_codes/MEDICAL_IDENTIFICATION_TAGS_View_ProductTaxCodes_Taxes.png
      :class: with-border
 ...
 * View Change History: See the log of edits of this product tax code by clicking on the **Change History** link to the tp right of the page.
   ...
   .. image:: /complete_reference/img/taxes/product_tax_codes/MEDICAL_IDENTIFICATION_TAGS_View_ProductTaxCodes_Taxes_ChangeHistory.png
      :class: with-border
 ...
 * View details of the product linked to this product tax code: Click on the line with the customer account details.
   ...
   .. image:: /complete_reference/img/taxes/product_tax_codes/ProductTaxCodeLinkedProduct.png
      :class: with-border
