...
.. include:: /complete_reference/overview/system/workflows_overview.rst
  :start-after: begin


.. image:: /complete_reference/img/system/workflows/Workflows.png
   :class: with-border
...
.. image:: /complete_reference/img/system/workflows/workflows/wf_general.png
...
.. image:: /complete_reference/img/system/workflows/workflows/wf_display_widget.png
  
- When this box is checked, all the possible workflow steps are shown and the current step is highlighted

.. image:: /complete_reference/img/system/workflows/workflows/wf_display_widget_ordered.png
...
.. image:: /complete_reference/img/system/workflows/workflows/wf_designer_step_form.png
...
.. image:: /complete_reference/img/system/workflows/workflows/wf_designer_transition_form.png
...
the transition buttons are available in the top right corner of the entity `grid <../../complete_reference/advanced/data_management/grid.html>`.
...
.. image:: /complete_reference/img/system/workflows/workflows/wf_display_grid.png


Button of all the transitions, for which pre-conditions (if any) are met, are displayed at
`View pages <../../complete_reference/advanced/data_management/view.html>`_ of the entity records.
...
.. image:: /complete_reference/img/system/workflows/workflows/wf_display_view.png
...
.. image:: /complete_reference/img/system/workflows/workflows/wf_display_step.png
...
.. image:: /complete_reference/img/system/workflows/workflows/wf_grid_actions_system.png
...
- Get to the `View page <../../complete_reference/advanced/data_management/view.html>`_ of the channel:  |IcView|

From the `View page <../../complete_reference/advanced/data_management/view.html>`_:

.. image:: /complete_reference/img/system/workflows/workflows/wf_view_system.png
...
.. image:: /complete_reference/img/system/workflows/workflows/wf_grid_actions_custom.png

- Delete the workflow: |IcDelete|

- Get to the `Edit from <../../../complete_reference/advanced/data_management/form.html>`_ of the workflow
...
.. |create_wf_page| image:: /complete_reference/img/system/workflows/workflows/create_wf_page.png

.. |wf_designer_step| image:: /complete_reference/img/system/workflows/workflows/wf_designer_step.png

.. |wf_designer_transition| image:: /complete_reference/img/system/workflows/workflows/wf_designer_transition.png

.. |wf_designer_transition_attributes| image:: /complete_reference/img/system/workflows/workflows/wf_designer_transition_attributes.png
...
.. |IcActivate| image:: /complete_reference/img/common/buttons/IcActivate.png
   :align: middle   
   
.. |IcDeactivate| image:: /complete_reference/img/common/buttons/IcDeactivate.png
   :align: middle   
   
.. |IcClone| image:: /complete_reference/img/common/buttons/IcClone.png
   :align: middle   
