...
.. include:: /complete_reference/overview/system/system_calendars_overview.rst
  :start-after: begin


.. .. image:: //complete_reference/img/system/system_calendars/SystemCalendars.png
   :class: with-border
...
(subject to the `roles and permissions defined <user_management/roles.html>`_), as well as to events 
...
`roles <user_management/roles.html>`_
and `capabilities <../../system/user_management/roles/preset.html>`_.
...
- The *"Create System Calendar"* `form <../../../complete_reference/advanced/data_management/form.html>`_ will appear:
...
.. image:: /complete_reference/img/system/system_calendars/calendars/create_system_cal.png
...
- Go to the `View page <../../complete_reference/advanced/data_management/view.html>`_ of the calendar.

- Click the :guilabel:`Create Calendar Event` button.

- The *"Create Calendar Event"* `form <../../../complete_reference/advanced/data_management/form.html>`_ will appear. The form has the 
  following fields:
...
.. image:: /complete_reference/img/system/system_calendars/calendars/create_system_cal_event.png
...
.. image:: /complete_reference/img/system/system_calendars/calendars/system_cal_grid.png

- Delete a calendar/event from the system : |IcDelete|
  
- Get to the `Edit form <../../../complete_reference/advanced/data_management/form.html>`_ of the  calendar/event : |IcEdit|
  
- Get to the `View page <../../complete_reference/advanced/data_management/view.html>`_ of the  calendar/event : |IcView|
...
.. image:: /complete_reference/img/system/system_calendars/calendars/user_calendar.png
...
.. image:: /complete_reference/img/system/system_calendars/calendars/user_calendar_edit.png
...
.. image:: /complete_reference/img/system/system_calendars/calendars/user_calendar_add_user.png
...
.. image:: /complete_reference/img/system/system_calendars/calendars/user_calendar_plus.png
...
.. csv-table::
  ...
  `Edit forms <../../../complete_reference/advanced/data_management/form.html>`_ and `View pages <../../complete_reference/advanced/data_management/view.html>`_
  ."
  ...
  delete tasks and get to their `Edit forms <../../../complete_reference/advanced/data_management/form.html>`_ and 
  `View pages <../../complete_reference/advanced/data_management/view.html>`_." 



.. |UserMenu| image:: /complete_reference/img/common/buttons/user_menu.png
   :align: middle
