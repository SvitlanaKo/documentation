...
- Get to the `Edit form <../../../complete_reference/advanced/data_management/form.html>`_ of the user: |IcEdit|.

- Get to the `View page <../../../complete_reference/advanced/data_management/view.html>`_ of the user: |IcView|.
...
.. image:: /complete_reference/img/system/user_management/user_management/reset_password.png
...
The section contains all the `activities <../../../common_actions/actions.html>`_ related to the user.
