...
1. Click :guilabel:`+Add Address` in the right corner of the Account page.
   ...
   .. image:: /complete_reference/img/customers/customers/acc_add_address.png
      :class: with-border
...
2. Once you have filled in all the fields, click :guilabel:`Save`. 
   ...
   .. image:: /complete_reference/img/customers/customers/acc_address_saved.png
      :class: with-border
...
.. image:: /complete_reference/img/customers/customers/acc_address_correspondin_map.png
   :class: with-border
